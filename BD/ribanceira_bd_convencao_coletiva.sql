...
--
-- Table structure for table `convencao_coletiva`
--

DROP TABLE IF EXISTS `convencao_coletiva`;
...
--
-- Dumping data for table `convencao_coletiva`
--

LOCK TABLES `convencao_coletiva` WRITE;
/*!40000 ALTER TABLE `convencao_coletiva` DISABLE KEYS */;
/*!40000 ALTER TABLE `convencao_coletiva` ENABLE KEYS */;
UNLOCK TABLES;
