...
CREATE TABLE `informe` (
  ...
  KEY `tipo_idx` (`tipo`),
  KEY `mes_idx` (`mes_referencia`),
  KEY `vencimento_idx` (`vencimento`),
  CONSTRAINT `empresa` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2016-11-06 18:33:47
